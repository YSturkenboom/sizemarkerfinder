...
def generateProfiles():
  ...
  makePredictions(path + '/Data/899.txt', plt, 3, 5, 1, 'Sample from normal test set')
  ...
  makePredictions(path + '/DataNoDrop/1000.txt', plt, 3, 5, 6, 'Sample from no-drop test set')
  makePredictions(path + '/DataNoDrop/1200.txt', plt, 3, 5, 7, 'Sample from no-drop test set')
  makePredictions(path + '/DataNoDrop/1400.txt', plt, 3, 5, 8, 'Sample from no-drop test set')
  makePredictions(path + '/DataNoDrop/1600.txt', plt, 3, 5, 9, 'Sample from no-drop test set')
  makePredictions(path + '/DataNoDrop/1800.txt', plt, 3, 5, 10, 'Sample from no-drop test set')
  makePredictions(path + '/DataNoHarm/1000.txt', plt, 3, 5, 11, 'Sample from no-harmonica test set')
  makePredictions(path + '/DataNoHarm/1200.txt', plt, 3, 5, 12, 'Sample from no-harmonica test set')
  makePredictions(path + '/DataNoHarm/1400.txt', plt, 3, 5, 13, 'Sample from no-harmonica test set')
  makePredictions(path + '/DataNoHarm/1600.txt', plt, 3, 5, 14, 'Sample from no-harmonica test set')
  makePredictions(path + '/DataNoHarm/1800.txt', plt, 3, 5, 15, 'Sample from no-harmonica test set')
