...
def generateProfiles():
  ...
  makePredictions(path + '/Test/Data/799.txt', plt, 352, 'Sample from normal test set')
  makePredictions(path + '/Test/Data/599.txt', plt, 353, 'Sample from normal test set')
  makePredictions(path + '/Test/Data/399.txt', plt, 354, 'Sample from normal test set')
  makePredictions(path + '/Test/Data/299.txt', plt, 355, 'Sample from normal test set')
  makePredictions(path + '/Test/DataNoDrop/0.txt', plt, 356, 'Sample from no-drop test set')
  makePredictions(path + '/Test/DataNoDrop/200.txt', plt, 357, 'Sample from no-drop test set')
  makePredictions(path + '/Test/DataNoDrop/400.txt', plt, 358, 'Sample from no-drop test set')
  makePredictions(path + '/Test/DataNoDrop/600.txt', plt, 359, 'Sample from no-drop test set')
  makePredictions(path + '/Test/DataNoDrop/800.txt', plt, 3510, 'Sample from no-drop test set')
  makePredictions(path + '/Test/DataNoHarm/0.txt', plt, 3511, 'Sample from no-harmonica test set')
  makePredictions(path + '/Test/DataNoHarm/200.txt', plt, 3512, 'Sample from no-harmonica test set')
  makePredictions(path + '/Test/DataNoHarm/400.txt', plt, 3513, 'Sample from no-harmonica test set')
  makePredictions(path + '/Test/DataNoHarm/600.txt', plt, 3514, 'Sample from no-harmonica test set')
  makePredictions(path + '/Test/DataNoHarm/800.txt', plt, 3515, 'Sample from no-harmonica test set')
