...
def generateProfiles():
  ...
  makePredictions(path + '/DataNoDrop/1100.txt', plt, 3, 5, 6, 'Sample from no-drop test set')
  ...
  makePredictions(path + '/DataNoHarm/1100.txt', plt, 3, 5, 11, 'Sample from no-harmonica test set')
